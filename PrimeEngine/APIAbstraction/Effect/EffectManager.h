...
struct EffectManager : public PE::PEAllocatableAndDefragmentable
{
	...
	void setTextureAndDepthTextureRenderTargetForDeferredGlow();
...
public:
	...
	// ms1 deferred rendering
	Handle m_hGlowMultipleTargetTextureGPU;
...
public:
	...
	Handle m_hLightVolumeVertexBufferGPU;
	Handle m_hLightVolumeIndexBufferGPU;
