...
struct TextureGPU : PE::PEAllocatableAndDefragmentable
{
	...
	void createDeferredTextureNoFamily(const char* textureFilename, const char* package = NULL);
	...
	void createDeferredTextureGPU(const char* textureFilename, const char* package, ESamplerState samplerState = SamplerState_Count);
	...
	void createDrawableIntoDeferredTexture(PrimitiveTypes::UInt32 w, PrimitiveTypes::UInt32 h, ESamplerState sampler);
	...
	void createMultipleDrawableIntoColorTextureWithDepth(PrimitiveTypes::UInt32 w, PrimitiveTypes::UInt32 h, ESamplerState sampler, bool use32BitRedForDepth = false);
	...
	GLuint m_deferredTexture_pos;
	GLuint m_deferredTexture_normal;
