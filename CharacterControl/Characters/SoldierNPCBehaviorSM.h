...
struct SoldierNPCBehaviorSM : public PE::Components::Component
{
	...
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCMovementSM_Event_TARGET_SHOOT)
	virtual void do_SoldierNPCMovementSM_Event_TARGET_SHOOT(PE::Events::Event* pEvt);
	//
