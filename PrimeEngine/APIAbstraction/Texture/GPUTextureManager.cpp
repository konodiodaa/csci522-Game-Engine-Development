...
Handle GPUTextureManager::createDeferredTextureGPU(const PrimitiveTypes::String textureFilename, const char* package, ESamplerState samplerState/* = SamplerState_Count*/)
{
	char path[256];
	StringOps::concat(textureFilename, package, path, 256);
	...
	pTex->createDeferredTextureGPU(textureFilename, package, samplerState);
