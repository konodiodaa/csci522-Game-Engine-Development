...
void runDrawThreadSingleFrame(PE::GameContext &ctx)
{
	...
	if (!disableScreenSpaceEffects)
    {
        ...
        //EffectManager::Instance()->setTextureAndDepthTextureRenderTargetForGlow(); // write to texture m_hGlowTargetTextureGPU-> a framebuffer
        // ms1 set deferred texture to write 
		EffectManager::Instance()->setTextureAndDepthTextureRenderTargetForDeferredGlow();
