...
void SA_Bind_Resource::PerEffectBindIds::initialize(Effect *pEffect)
{
	...
	FindSamplerBinding(pEffect, m_samplerParameters[POSITION_TEXTURE_2D_SAMPLER_SLOT], "gPositionSampler");
	m_samplerParameterNames[POSITION_TEXTURE_2D_SAMPLER_SLOT] = "gPositionSampler";

	FindSamplerBinding(pEffect, m_samplerParameters[NORMAL_TEXTURE_2D_SAMPLER_SLOT], "gNormalSampler");
	m_samplerParameterNames[NORMAL_TEXTURE_2D_SAMPLER_SLOT] = "gNormalSampler";
#endif
}
#endif
